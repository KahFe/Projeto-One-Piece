/* 
    PRIMEIRO PASSO ANTES DE CRIAR O CÓDIGO, A ESTRUTURA DO SITE: CRIAR O ALGORITMO (INSTRUÇÕES) 
    PARA SE TER NOÇÃO DO QUE PRECISA SER FEITO.
...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        desselecionarBotao(); // Isso é refatorar os códigos, tornando-os mais enxutos criando uma função que os leva lá para baixo.
